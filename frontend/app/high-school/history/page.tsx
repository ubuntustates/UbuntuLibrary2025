...
export default function HistoryHighSchool() {
  const subject = "History"; // dynamically used in hero text
  const levels = [
    { name: "SSS 1", icon: <BookOpen className="w-6 h-6" />, href: "/high-school/history/sss-1" },
    { name: "SSS 2", icon: <BookOpen className="w-6 h-6" />, href: "/high-school/history/sss-2" },
    { name: "SSS 3", icon: <BookOpen className="w-6 h-6" />, href: "/high-school/history/sss-3" },
  ];
